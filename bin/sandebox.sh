...
# Default-Stop:       0 1 6
# Short-Description:  Start sandebox
### END INIT INFO
#
#   make a link to/copy of this file from/to etc/init.d;
# ln -s <this file> /etc/init.d/
#   or
# cp <this file> /etc/init.d/
#
# create the runlevel-links like this;
# sudo update-rc.d sandebox defaults 50
#
# now this should work;
# invoke-rc.d sandebox start
# invoke-rc.d sandebox stop
